...
CONFIG_SCHEMA = (
    cv.Schema({
        ...
        cv.Optional("humidity"): sensor.sensor_schema(LevoitSensor, icon=ICON_BLUR, accuracy_decimals=0, device_class=DEVICE_CLASS_HUMIDITY, state_class=STATE_CLASS_MEASUREMENT)
    })
)
